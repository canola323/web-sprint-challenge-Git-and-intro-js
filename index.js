...
/*const myInfo = { 
    id: 20,
    name: 'Jonathan Canola', 
    years: '1994 - present',
    genre:'Web Design', 
    nationality: 'Italian',
    bio: 'I like to eat fuego tacos when I code!'
  }*/
...
function artistByCountry(arr, artistNationality){
  const sameCountry = [];
  for(let i = 0; i < arr.length; i++){
    if(arr[i].nationality === artistNationality){
      sameCountry.push(arr[i].name);
    }
  }
  return sameCountry;
}
